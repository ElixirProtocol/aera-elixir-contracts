...
abstract contract Executor is IExecutor, ReentrancyGuard {
    ...
    function _executeOperation(Operation calldata operation) internal virtual {
    ...
    function _checkOperations(Operation[] calldata operations) internal view virtual;

    /// @dev Authorize the execution of a single operation.
    function _checkOperation(Operation calldata operation) internal view virtual;
}
